...
const (
	...
	// Using "omni" for SDK compatibility (Bech32 standard)
	// CLI displays addresses in 1x format for Omniphi branding
	AccountAddressPrefix = "omni"
	// ChainCoinType is the coin type of the chain.
	// 60 = Ethereum (ETH) for Ethereum-compatible addresses
	ChainCoinType = 60
)
