# Start Validator 2 (Computer 2) - Windows PowerShell
...
if (-not (Test-Path $VALIDATOR_HOME)) {
    ...
    Write-Host "Please extract the validator2 package first!"
    exit 1
}
...
Write-Host "  Starting Validator 2" -ForegroundColor Cyan
