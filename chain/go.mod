...
replace (
	...
	// use sonic v1.14.2 with Go 1.24 support
	github.com/bytedance/sonic => github.com/bytedance/sonic v1.14.2
	// Pin CometBFT ONLY - let others auto-resolve
	...
	// Pin bbolt to stable release — v1.4.0-alpha.1 is not production-ready
	go.etcd.io/bbolt => go.etcd.io/bbolt v1.3.11
	nhooyr.io/websocket => github.com/coder/websocket v1.8.7
)

// Note: authz module was removed from this chain
// - Module was scaffolded by Ignite CLI but never used
// - cosmossdk.io/x/authz v0.2.0-rc.1 has broken dependencies:
//   * github.com/cosmos/cosmos-sdk/types/authz (doesn't exist)
//   * github.com/cosmos/cosmos-sdk/simsx (doesn't exist)
//   * cosmossdk.io/core/appconfig (not in core v0.11.3 or v1.0.0)
// - If authz is needed in future, use SDK's built-in authz:
//   github.com/cosmos/cosmos-sdk/x/authz (included in cosmos-sdk v0.53.3)
// - Do NOT add cosmossdk.io/x/authz as it will break go mod tidy
